...
public class Pacman extends JPanel {
    ...
    private final Queue<TheGhost> ghostPenQ = new LinkedList<>();
    ...
    /**
     * If Pacman hits a ghost and it's not on frightened mode Move pacman back
     * to initial position, decrement lives
     */
    ...
    /**
     * Listens to keyboard events, sets the facing direction based on those
     * events Then moves the item in regards to the facing direction
     */
    ...
    /**
     * If it is time, removes next ghost from pen and places ghost at initial
     * ghostReleasePoint
     */
    ...
    /**
     * Removes ghost from its position on the board, updates ghosts coordinates
     * to that of initial point, updates board to that value
     */
    ...
    /**
     * Updates the score, num lives, ghost pen release countdown, and ghost mode
     * labels
     */
    private void updateLabels() {
        ...
        if (null != gameMode) switch (gameMode) {
            case FRIGHTENED:
